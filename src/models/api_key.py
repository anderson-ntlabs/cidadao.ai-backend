...
class APIKey(BaseModel):
    ...
    def get_rate_limits(self) -> dict:
        ...
        tier_limits = {
            APIKeyTier.FREE: {"per_minute": 10, "per_hour": 100, "per_day": 1000},
            APIKeyTier.BASIC: {"per_minute": 30, "per_hour": 500, "per_day": 5000},
            APIKeyTier.PRO: {"per_minute": 60, "per_hour": 2000, "per_day": 20000},
