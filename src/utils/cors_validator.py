...
class CORSValidator:
    ...
    async def validate_origin(
        self, origin: str, endpoint: str = "/health", method: str = "GET"
        ...
        """
        headers = {"Origin": origin, "User-Agent": "CORS-Validator/1.0"}
    ...
    async def test_all_origins(self) -> dict[str, dict[str, any]]:
        ...
        for origin in settings.cors_origins:
            ...
            results[origin] = {"allowed": is_allowed, "headers": headers}
...
"""
    ...
    async def test_credentials_flow(
        self, origin: str = "https://cidadao-ai-frontend.vercel.app"
    ) -> dict[str, any]:
        """Test CORS with credentials (cookies/auth)."""
        results = {"origin": origin, "tests": {}}
