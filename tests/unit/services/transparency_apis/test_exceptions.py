...
class TestExceptionHierarchy:
    ...
    def test_timeout_error_inheritance(self):
        ...
        error = TimeoutError("Request timeout", api_name="TestAPI", timeout_seconds=30)
...
class TestOriginalErrorChaining:
    ...
    def test_original_error_preserved(self):
        ...
        error = NetworkError(
            "Network failed", api_name="TestAPI", original_error=original
        )
...
class TestSpecificExceptions:
    ...
    def test_timeout_error_with_seconds(self):
        ...
        error = TimeoutError(
            "Timeout occurred", api_name="IBGE", timeout_seconds=30.5, status_code=408
        )
    ...
    def test_rate_limit_error_with_retry_after(self):
        ...
        error = RateLimitError(
            "Rate limit exceeded", api_name="DataSUS", retry_after=60
        )
    ...
    def test_rate_limit_error_without_retry_after(self):
        ...
        error = RateLimitError("Rate limit exceeded", api_name="INEP")
    ...
    def test_not_found_error_with_resource_id(self):
        ...
        error = NotFoundError(
            "Resource not found", api_name="IBGE", resource_id="municipality-123"
        )
    ...
    def test_authentication_error_attributes(self):
        ...
        error_401 = AuthenticationError(
            "Invalid credentials", api_name="TestAPI", status_code=401
        )
        assert error_401.status_code == 401

        # Test 403 Forbidden
        error_403 = AuthenticationError(
            "Access forbidden", api_name="TestAPI", status_code=403
        )
...
class TestExceptionFactory:
    ...
    def test_factory_creates_validation_error_400(self):
        ...
        error = exception_from_response(
            400, "Bad request", api_name="TestAPI", response_data={"detail": "invalid"}
        )
    ...
    def test_factory_creates_authentication_error_401(self):
        ...
        error = exception_from_response(401, "Unauthorized", api_name="TestAPI")
    ...
    def test_factory_creates_authentication_error_403(self):
        ...
        error = exception_from_response(403, "Forbidden", api_name="TestAPI")
    ...
    def test_factory_creates_not_found_error_404(self):
        ...
        error = exception_from_response(
            404, "Not found", api_name="IBGE", response_data={"resource": "state-99"}
        )
    ...
    def test_factory_creates_rate_limit_error_429(self):
        ...
        error = exception_from_response(429, "Too many requests", api_name="DataSUS")
    ...
    def test_factory_creates_server_error_500(self):
        ...
        error = exception_from_response(500, "Internal server error", api_name="INEP")
    ...
    def test_factory_creates_server_error_502(self):
        ...
        error = exception_from_response(502, "Bad gateway", api_name="TestAPI")
    ...
    def test_factory_creates_server_error_503(self):
        ...
        error = exception_from_response(503, "Service unavailable", api_name="TestAPI")
    ...
    def test_factory_creates_timeout_error_504(self):
        ...
        error = exception_from_response(504, "Gateway timeout", api_name="TestAPI")
    ...
    def test_factory_creates_federal_api_error_for_unknown(self):
        ...
        error = exception_from_response(
            418, "Unknown error", api_name="TestAPI"  # I'm a teapot
        )
    ...
    def test_factory_preserves_all_context(self):
        ...
        error = exception_from_response(
            500, "Server error", api_name="IBGE", response_data=response_data
        )
